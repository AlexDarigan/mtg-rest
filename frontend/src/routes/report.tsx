...
function Report() {
  return (
    ...
    <PanelGroup bordered style={{fontSize: "1rem"}}>
      ...
      <br></br><br></br>
      <Panel header={<h5>Example Request</h5>} bordered>GET api.hostname/stats/colors</Panel>
      <br></br>
      <Panel header={<h5>Example Response</h5>} bordered>
        {response_example}
      </Panel>
      <br></br>
      <Panel header={<h5>Data Sources</h5>}>
